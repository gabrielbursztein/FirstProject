...
Devise.setup do |config|
  ...
  # config.secret_key = '4d9bac6f3e456330450eb4638fa87f16ac2e7e
  # 1b06c13c7866a539b6b122198dac19e9b44fa210bf6dfcb0e34049d889142e15073d
  # 7624cfbfe4afe462c31b11'
  ...
  # Remember that those
  # parameters are used only when authenticating and not when
  # retrieving from
  ...
  # determining whether
  # or not authentication should be aborted when the value
  # is not present.
  ...
  # For instance,
  # if you set :request_keys to [:subdomain], :subdomain
  ...
  # requires the Devise mappings to be loaded during boot
  ...
  # config.pepper = 'bf1805d799bdc59c10eded32b31509f380678
  # 09bda377ab6179455a480a68bf
  # a2299c965caa3d3fd744bc75a938dca9237b4e2a7e307b45ce54b51cf5d99bae5'
